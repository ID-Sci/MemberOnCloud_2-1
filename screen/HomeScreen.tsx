...
import { updateNotificationList, clearNotificationList, updateNotificationPage, clearNotificationPage,notificationSelector } from '../src/store/slices/notificationReducer';
...
const HomeScreen = ({ route }: any) => {
    ...
    const FetchDataProject = async (ProjList: object) => {
        const checkLoginToken = await Keychain.getGenericPassword();
        const configToken = checkLoginToken ? JSON.parse(checkLoginToken.password) : null
    ...
    const fetchLayoutData = async (LayoutKey: String, LayoutList: object) => {
        const checkLoginToken = await Keychain.getGenericPassword();
        const configToken = checkLoginToken ? JSON.parse(checkLoginToken.password) : null
    ...
    const fetchPageData = async (PageKey: String, PageList: object) => {
        const checkLoginToken = await Keychain.getGenericPassword();
        const configToken = checkLoginToken ? JSON.parse(checkLoginToken.password) : null
